def errors(err_code):
    err_dic = {0: ('OP_ERR_NONE', '정상처리'),
                ...
                -201: ('OP_ERR_STRUCT_FAIL', '전문작성초기화실패'),
                -202: ('OP_ERR_STRING_FAIL', '전문작성입력값오류'),
                ...
                -302: ('OP_ERR_OTHER_ACC_USE', '타인계쫘사용오류'),
                ...
                -340: ('OP_ERR_ORD_WRONG_ACCTINFO', '계쫘정보없음'),
